/* Generated by Pyrex 0.9.9 on Wed Feb 04 18:37:20 2015 */
...
/* Declarations from Domain.CCS.utils */


/* Declarations from implementation of Domain.CCS.utils */

static PyObject *__pyx_f_6Domain_3CCS_5utils_dactivation(float,int); /*proto*/

static char __pyx_k1[] = "expit";
static char __pyx_k2[] = "scipy.special";

static PyObject *__pyx_n_expit;

static PyObject *__pyx_k2p;

static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_expit, 1, __pyx_k1, sizeof(__pyx_k1)},
...
/* Implementation of Domain.CCS.utils */

static PyObject *__pyx_f_6Domain_3CCS_5utils_dactivation(float __pyx_v_y,int __pyx_v_function) {
  PyObject *__pyx_r;
  int __pyx_1;
  PyObject *__pyx_2 = 0;
  PyObject *__pyx_3 = 0;
  PyObject *__pyx_4 = 0;
  __pyx_1 = (__pyx_v_function == 0);
  if (__pyx_1) {
    __pyx_2 = PyFloat_FromDouble(tanh(__pyx_v_y)); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; goto __pyx_L1;}
    __pyx_r = __pyx_2;
    __pyx_2 = 0;
    goto __pyx_L0;
    goto __pyx_L2;
  }
  __pyx_1 = (__pyx_v_function == 1);
  if (__pyx_1) {
    __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_expit); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; goto __pyx_L1;}
    __pyx_3 = PyFloat_FromDouble(__pyx_v_y); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; goto __pyx_L1;}
